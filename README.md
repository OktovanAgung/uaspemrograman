...
![package&module](assets/gambar/gambar1.png)
...
* nyatakan fungsi ``def tambah_data() :``
* ``nama = input("Masukan nama : "`` lalu tambahkan input nama, nim, nilai tugas, uts, uas
* ``nilai_akhir = (nilai_tugas)*30/100 + (nilai_uts)*35/100 + (nilai_uas)*35/100 `` untuk nilai akhir diambil dari perhitungan 3 komponen nilai (nilai_tugas: 30%, nilai_uts: 35%, nilai-uas:35 35%)
* ``data[nama] = [nama, nim, nilai_tugas, nilai_uts, nilai_uas, nilai_akhir]`` kita akan masukkan data yang tadi kita input ke dalam `data[nama]'
* lalu cetak ``print()``

*-Ubah data*
* nyatakan fungsi ``def ubah_data():``
...
![output](assets/gambar/gambar2.png)


Ubah Data

![output](assets/gambar/gambar3.png)


Lihat Data

![output](assets/gambar/gambar4.png)


Cari Data

![output](assets/gambar/gambar5.png)


Hapus Data

![output](assets/gambar/gambar6.png)


**Flowchart**


![flowchart](assets/gambar/flowchart.png)
